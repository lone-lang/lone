...
enum lone_elf_segment_type {
	LONE_ELF_SEGMENT_TYPE_NULL                 = 0,
	LONE_ELF_SEGMENT_TYPE_LOADABLE             = 1,
	LONE_ELF_SEGMENT_TYPE_DYNAMIC              = 2,
	LONE_ELF_SEGMENT_TYPE_INTERPRETER          = 3,
	LONE_ELF_SEGMENT_TYPE_NOTE                 = 4,
	LONE_ELF_SEGMENT_TYPE_SHARED_LIBRARY       = 5,
	LONE_ELF_SEGMENT_TYPE_PROGRAM_HEADER_TABLE = 6,
	LONE_ELF_SEGMENT_TYPE_THREAD_LOCAL_STORAGE = 7,

	                            /* l o n e */
	LONE_ELF_SEGMENT_TYPE_LONE = 0x6c6f6e65,

	LONE_ELF_SEGMENT_TYPE_LOAD     = LONE_ELF_SEGMENT_TYPE_LOADABLE,
	LONE_ELF_SEGMENT_TYPE_INTERP   = LONE_ELF_SEGMENT_TYPE_INTERPRETER,
	LONE_ELF_SEGMENT_TYPE_SHLIB    = LONE_ELF_SEGMENT_TYPE_SHARED_LIBRARY,
	LONE_ELF_SEGMENT_TYPE_SEGMENTS = LONE_ELF_SEGMENT_TYPE_PROGRAM_HEADER_TABLE,
	LONE_ELF_SEGMENT_TYPE_PHDR     = LONE_ELF_SEGMENT_TYPE_PROGRAM_HEADER_TABLE,
...
enum lone_elf_ranges_segment_type {
	...
	LONE_ELF_RANGES_SEGMENT_TYPE_OS_MIN   = 0x60000000,
	LONE_ELF_RANGES_SEGMENT_TYPE_OS_MAX   = 0x6fffffff,
	LONE_ELF_RANGES_SEGMENT_TYPE_PROC_MIN = 0x70000000,
	LONE_ELF_RANGES_SEGMENT_TYPE_PROC_MAX = 0x7fffffff,
};
...
enum lone_elf_ranges_segment_flags {
	...
	LONE_ELF_RANGES_SEGMENT_FLAGS_OS_MASK   = 0x0ff00000,
	LONE_ELF_RANGES_SEGMENT_FLAGS_PROC_MASK = 0xf0000000,
};
